...
ARG BASEIMAGE=rocm/miopen:ci_ee5a5b
...
ARG MIOPEN_CMAKE_ARGS="-DMIOPEN_USE_MLIR=${MIOPEN_USE_MLIR} -DMIOPEN_INSTALL_CXX_HEADERS=On -DMIOPEN_CACHE_DIR=${MIOPEN_CACHE_DIR} -DMIOPEN_USER_DB_PATH=${MIOPEN_USER_DB_PATH} -DMIOPEN_BACKEND=${BACKEND} -DMIOPEN_ENABLE_FIN_INTERFACE=On -DCMAKE_PREFIX_PATH="${MIOPEN_DEPS};${PREFIX}""
